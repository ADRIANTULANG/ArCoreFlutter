...
import '../controller/admin_addproducts_controller.dart';

class AdminAddProductsView extends GetView<AdminAddProductsController> {
  const AdminAddProductsView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(AdminAddProductsController());
    return Scaffold(
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              if (controller.productname.text.isEmpty ||
                                ...
                                Get.snackbar("Message",
                                    ...
                                    backgroundColor: Colors.red,
                                    colorText: Colors.white);
                              } else if (controller.pickedARfile == null) {
                                Get.snackbar(
                                    "Message", "3D Model file missing.",
                                    backgroundColor: Colors.red,
                                    colorText: Colors.white);
                            ...
                            child: Text("ADD PRODUCT", style: Styles.header1),
                          ),
                        ),
                      ),
                      SizedBox(
